...
> **Release:** `0.1.0`<br>
> **Maturity:** first stable release; SemVer guarantees apply<br>
...
`0.1.0` is the first stable release with standard SemVer guarantees
(1.0+ compatibility discipline). Pinning the exact version is still
