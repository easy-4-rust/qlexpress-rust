//! 小于操作符 `<`
//!
//! 对应 Java: com.alibaba.qlexpress4.runtime.operator.compare.LessOperator
//! (@author bingo)。
...
/// 小于操作符 `<`。
///
/// 对应 Java: LessOperator(单例模式,`getInstance()`;Rust 为零大小类型)。
...
impl BinaryOperator for LessOperator {
