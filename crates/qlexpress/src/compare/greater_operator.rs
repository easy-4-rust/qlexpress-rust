//! 大于操作符 `>`
//!
//! 对应 Java: com.alibaba.qlexpress4.runtime.operator.compare.GreaterOperator
//! (@author bingo)。
...
/// 大于操作符 `>`。
///
/// 对应 Java: GreaterOperator(单例模式,`getInstance()`;Rust 为零大小类型)。
...
impl BinaryOperator for GreaterOperator {
